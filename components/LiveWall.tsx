...
export const LiveWall: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F2EFE9] text-charcoal font-serif relative overflow-hidden">
      {/* Background Texture */}
      ...
      {/* Header */}
      <header className="pt-8 pb-4 text-center relative z-10 bg-[#F2EFE9]/90 backdrop-blur-sm sticky top-0 shadow-sm border-b border-gold/20">
        <h1 className="font-script text-5xl md:text-6xl text-gold-shine mb-2">Natthamonpisit & Sorot</h1>
      ...
      <main className="max-w-[1600px] mx-auto p-8 relative z-10">
            ...
            {wishes.map((wish, idx) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="font-serif text-xl md:text-2xl text-charcoal italic mb-4 leading-relaxed relative">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-end">
                  <span className="font-sans font-bold text-sm uppercase text-gold tracking-wider truncate max-w-[70%]">
                    {wish.name}
                  </span>
        ...
        {!loading && wishes.length === 0 && (
          <div className="text-center py-40">
             <p className="font-serif text-3xl text-charcoal/40 italic">Waiting for the first wish...</p>
             <p className="font-sans text-sm text-gold mt-4 uppercase tracking-widest">Scan QR code to sign guestbook</p>
          </div>
        )}
      </main>
    </div>
