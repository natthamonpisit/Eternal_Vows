...
export const Gallery: React.FC = () => {
  ...
  return (
    ...
    <section className="py-24 px-4 relative min-h-[80vh] flex flex-col justify-center">
      ...
      <div 
        ref={headerRef}
        className={`text-center mb-16 md:mb-20 will-change-transform transform-gpu backface-hidden transition-all duration-[1200ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
          isHeaderVisible 
