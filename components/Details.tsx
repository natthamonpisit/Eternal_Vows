  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden bg-old-rose">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10 space-y-24">
        ...
        {/* =========================================
            SECTION 1: THE SCHEDULE (Clean & Spaced)
           ========================================= */}
        <div>
          ...
          <div className="max-w-4xl mx-auto relative">
             ...
             {/* 
                 THE TIMELINE LINE 
                 - Positioned at approx 35% from left on Desktop
                 - Just a subtle vertical line, NO DOTS
             */}
             ...
             <div className="space-y-12">
               {events.map((event, idx) => (
                 <div key={idx} className="relative flex items-center group">
                    ...
                    {/* RIGHT GROUP: Content */}
                    {/* Increased padding-left (pl-16 md:pl-24) to separate from line */}
