...
/*
  ...
  *** กฏเหล็ก (Strict Rule): ห้ามเปลี่ยน Style แยกกัน ต้องเหมือนกันทั้ง 3 ส่วน ***
  ...
  ----------------------------------------------------------------------------------------
  5. MAINTENANCE PROTOCOL (กฏการดูแลรักษา - อ่านก่อนแก้โค้ด)
  ----------------------------------------------------------------------------------------
  RULE: "FOCUSED FIXES ONLY"
  - หากได้รับคำสั่งให้แก้ส่วนไหน ให้แก้ "เฉพาะส่วนนั้น" เท่านั้น
  - ห้ามเปลี่ยน Design System, ห้ามปรับ Spacing, ห้ามเปลี่ยน Font หรือสี ถ้าไม่ได้ถูกสั่ง
  - ห้ามเพิ่ม Feature ที่ไม่ได้ขอ
  - ห้ามลบ Comment หลักนี้เด็ดขาด เพื่อให้ Dev คนถัดไปเข้าใจบริบทงาน
  ----------------------------------------------------------------------------------------
*/
